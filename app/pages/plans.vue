...
const plans = [
  {
    name: 'Free',
    price: 'R$ 0',
    features: ['2 templates', 'Exportação HTML', '3 perfis salvos', 'QR Code básico', 'Copiar HTML'],
    cta: 'Plano atual',
    highlight: false,
  },
  {
    name: 'Premium',
    price: 'R$ 29/mês',
    features: ['10+ templates exclusivos', 'Exportação PNG/ZIP/SVG', 'Perfis ilimitados', 'Upload de imagens', 'Suporte prioritário', 'Compartilhamento por link', 'Sem marca d\'água'],
    cta: 'Ativar Premium',
    highlight: true,
  },
]
...
function handleUpgrade() {
  ...
  toast.success('🎉 Premium ativado!', { description: 'Todos os recursos estão disponíveis.' })
}
</script>
  ...
  <div class="min-h-screen bg-background p-4">
    <div class="container max-w-3xl py-10">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-muted-foreground mt-2">Desbloqueie recursos exclusivos para suas assinaturas</p>
      </div>

      <div class="grid sm:grid-cols-2 gap-6">
        <div v-for="(plan, i) in plans" :key="plan.name">
          <UCard :class="plan.highlight ? 'border-2 border-primary shadow-lg' : ''">
            <template #header>
